...
export const profile: Profile = {
  name: "Marco Schlude",
  title: "Softwareentwickler | ERP, Datenbanken & KI-Anwendungen",
  tagline: "ERP-Tiefe trifft auf modernen Fullstack- und Cloud-Stack.",
  shortBio:
    "Softwareentwickler mit Schwerpunkt auf SQL, ERP-Systemen (IBM i / AS400, RPG) und Datenbanken – erweitert um moderne Fullstack- und KI-Anwendungen mit Next.js, TypeScript, FastAPI und Cloud-Deployment.",
  bio:
  ...
  availability: {
    status: "auf-anfrage",
    label: "Verfügbar nach Absprache",
    note: "Bevorzugt Remote-Positionen · offen für Festanstellung und Projektarbeit im ERP- und KI-Umfeld.",
  },
